...
public class WizardStepFilter extends AbstractI18NCustomComponent implements WizardStep {
	...
	public WizardStepFilter() {
		...
		StringBuffer helpTachosUpload = new StringBuffer("Desde esta pantalla usted podrá escojer los filtros para seleccionar los ficheros de tacógrafo y/o tarjeta.<br>");
	...
	private HorizontalLayout buildFilterToolbarLayout() {
		...
		filterToolbarLayout.setMargin(true);
