...
@Theme("valo-test")
public class TachoCalendar extends GridLayout implements View {
    ...
    public TachoCalendar() {
        ...
        calendarComponent.setReadOnly(true);
    ...
    private void addInitialEvents() {
        ...
        TachoCalendarEvent event = getNewEvent("Whole week event", start, end);
    ...
    private void initLayoutContent() {
        ...
        viewCaption.setVisible(false); // TODO
    ...
    private void initFormFields(Layout formLayout,
        ...
        if (eventClass == TachoCalendarEvent.class) {
    ...
    private TachoCalendarEvent getNewEvent(String caption, Date start, Date end) {
        TachoCalendarEvent event = new TachoCalendarEvent();
